...
| $FN\\%$      | $\frac{FN}{TP+FP+FN}$                                 | The lower the better. High value of type-2-blue error means model is too conservative to make extraction                                                                                                                                                                                                                                                                                        |
| $TPR/Recall$ | $\frac{TP}{TP+FN}=\frac{TP}{P}$                               | Standard metric. For a given POSITIVE, the probability that can be extracted correctly. If we want the papers to be extracted as much as possible, we need to observe this value closely.                                                                                                                                                                                                       |
| $FPR$        | $\frac{FP}{FP+TN}=\frac{FP}{N}$                               | For a given NEGATIVE, the probability that turns into an type-1 error. This might be used to reflect hallucination.                                                                                                                                                                                                                                                                             |
| $TNR$        | $\frac{TN}{FP+TN}=\frac{TN}{N}$                               | $1 - FPR$; for a given NEGATIVE, the probability that it'll be correctly extracted.                                                                                                                                                                                                                                                                                                             |
| $FNR$        | $\frac{FN}{TP+FN}=\frac{FN}{P}$                               | $1 - Recall$; a given POSITIVE, the probability it'll be a type-2 error.                                                                                                                                                                                                                                                                                                                        |
...
| $Precision$  | $\frac{TP}{TP+FP}$                                    | standard metric; when there is a POSITIVE extraction, the probability that this extraction is right. From a data consumer perspective, this shall be the most important metric.                                                                                                                                                                                                                 |
