...
| $FN\\%$           | $\frac{FN}{TP+FP+FN}$                               | The lower the better. High value of Type-II blue colored error means that the model is too conservative to make an extraction.                                                                                                                                                                                                                                                                              |
...
| $FPR$             | $\frac{FP}{FP+TN}=\frac{FP}{N}$                     | False Positive Rate. For a set of Negative cases, this value indicates the probability of the extracted results are Type-I errors. This might be used to reflect the hallucination of LLMs.                                                                                                                                                                                                                 |
| $TNR$             | $\frac{TN}{FP+TN}=\frac{TN}{N}$                     | $1 - FPR$. For a set of Negative cases, this value shows the probability of the extracted values are correct extractions.                                                                                                                                                                                                                                                                                   |
| $FNR$             | $\frac{FN}{TP+FN}=\frac{FN}{P}$                     | $1 - Recall$. For a set of Positive cases, this value shows the probability of the extracted results are type-II errors.                                                                                                                                                                                                                                                                                    |
