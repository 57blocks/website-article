...
In the case of CNNs, features may also be derived through an end-to-end process by employing fine-tuned CNN architectures, enhancing the model's adaptability to specific tasks<sup>[3]</sup><sup>[4]</sup>.  
...
[4] Bhatt H H , Mankodia A P .A Comprehensive Review on Content-Based Image Retrieval System: Features and Challenges[J].  2021.DOI:10.1007/978-981-15-4474-3_7.  
...
[7] Minghui Liao, Zhaoyi Wan, Cong Yao, Kai Chen, and Xiang Bai. 2020. Real-time scene text detection with differentiable binarization. In Proceedings of the AAAI Conference on Artificial Intelligence, Vol. 34. 11474--11481.  
